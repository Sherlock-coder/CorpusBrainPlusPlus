...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "input_path",
        type=str,
        default="datasets/nq-dev-kilt.jsonl",
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='*',
        help="Paths where save all the adapters to load",
    )
    parser.add_argument(
        "--batch_size",
        default=4,
    ...
    parser.add_argument(
        "--trie",
        type=str,
        default="kilt_titles_trie_dict.pkl",
    ...
    with torch.no_grad():
        ...
        model = (
            GENRE.from_pretrained(args.model_path, adapter_name_or_path_list=args.adapter_path_list, checkpoint_file=args.checkpoint_file)
            .eval()
            .to(args.device)
        )
